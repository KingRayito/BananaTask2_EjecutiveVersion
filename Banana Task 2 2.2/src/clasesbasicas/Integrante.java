...
public class Integrante {
	...
	public Integrante() {	//Constructor sin parametros
	}
	
	public Integrante(String identificador, String contraseña, String nombre, String ocupacion, boolean admin) {
		this.identificador = identificador;				//Constructor con parametros
	...
	public void agregarFase(String nombre, String descripcion, boolean completo) {
		listaProyectos.hgt
	}
	
	public String getIdentificador() {		//Getters y setters
